...
CREATE INDEX IF NOT EXISTS idx_materia_fornecedor_materia
  ON materia_fornecedor (materia_prima_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_permissao_modulo_par
  ON permissao_modulo (perfil_id, modulo_id);
